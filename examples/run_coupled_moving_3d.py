...
A propeller source flies a straight path across the array at z=5 m,
15 m/s.  Same domain and receiver setup as Example 3.

Usage::

    python examples/run_coupled_moving_3d.py --use-cuda
"""
...
def parse_args(argv=None):
    ...
    g.add_argument("--source-x0", type=float, default=10.0)
    g.add_argument("--source-y0", type=float, default=50.0)
    g.add_argument("--source-x1", type=float, default=90.0)
    g.add_argument("--source-y1", type=float, default=50.0)
...
def main(argv=None):
    ...
    source = MovingSource3D(
        x0=args.source_x0, y0=args.source_y0, z0=args.source_z,
        x1=args.source_x1, y1=args.source_y1, z1=args.source_z,
    ...
    if is_root:
        ...
        metadata = {
            ...
            "total_time": args.total_time,
            "source_start": [args.source_x0, args.source_y0, args.source_z],
            "source_end": [args.source_x1, args.source_y1, args.source_z],
