#!/usr/bin/env bash
# Example 4: 3-D coupled air-ground — moving propeller source
set -euo pipefail
...
python3 examples/run_coupled_moving_3d.py \
    ...
    --source-x0 10 --source-y0 50 --source-x1 90 --source-y1 50 \
    --source-z 5 --source-speed 15 \
    ...
    --output-dir output/coupled_moving_3d \
    $CUDA_FLAG
